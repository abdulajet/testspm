 ...
 jazzy --objc --author Nexmo --author_url https://developer.nexmo.com --module-version $1  --umbrella-header NexmoClient/NexmoClient.h --framework-root . --module NexmoClient   --output docs --readme UtilsNexmo/README.md
