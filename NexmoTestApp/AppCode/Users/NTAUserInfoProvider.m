    ...
    if(self == [NTAUserInfoProvider self]) {
        testAppUsers = @{
                         ...
                         @"testuser8":[[NTAUserInfo alloc] initWithName:@"testuser8" password:@"Vocal123!" displayName:@"Daniel Levi" csUserName:@"testuser8" csUserId:testuser8UserId csUserToken:testuser8Token userGroup:@"testUser"],
                           @"testuser9":[[NTAUserInfo alloc] initWithName:@"testuser9" password:@"Vocal123!" displayName:@"Hila Min" csUserName:@"testuser9" csUserId:testuser9UserId csUserToken:testuser8Token userGroup:@"testUser"],
                           @"testuser10":[[NTAUserInfo alloc] initWithName:@"testuser10" password:@"Vocal123!" displayName:@"Tamir Segal" csUserName:@"testuser10" csUserId:testuser10UserId csUserToken:testuser10Token userGroup:@"testUser"],
                           @"testuser11":[[NTAUserInfo alloc] initWithName:@"testuser11" password:@"Vocal123!" displayName:@"Ariel Tom" csUserName:@"testuser11" csUserId:testuser11UserId csUserToken:testuser8Token userGroup:@"testUser"],
                           @"testuser12":[[NTAUserInfo alloc] initWithName:@"testuser12" password:@"Vocal123!" displayName:@"Barak Raz" csUserName:@"testuser12" csUserId:testuser12UserId csUserToken:testuser8Token userGroup:@"testUser"],
                           @"testuser13":[[NTAUserInfo alloc] initWithName:@"testuser13" password:@"Vocal123!" displayName:@"Alon Eli" csUserName:@"testuser13" csUserId:testuser8UserId csUserToken:testuser13Token userGroup:@"testUser"],
        ...
        csUserNameToCSUserId = @{
                                 ...
                                 @"testuser9":testuser9UserId,
                                 @"testuser10":testuser10UserId,
                                 @"testuser11":testuser11UserId,
                                 @"testuser12":testuser12UserId,
                                 @"testuser13":testuser13UserId,
                                 @"baby1":baby1UserId,
                                 @"baby2":baby2UserId,
                                 @"baby3":baby3UserId,
                                 @"baby4":baby4UserId,
        ...
        csUserIdToCSUserName = @{
                                 ...
                                 testuser9UserId:@"testuser9",
                                 testuser10UserId:@"testuser10",
                                 testuser11UserId:@"testuser11",
                                 testuser12UserId:@"testuser12",
                                 testuser13UserId:@"testuser13",
                                 baby1UserId:@"baby1",
                                 baby2UserId:@"baby2",
                                 baby3UserId:@"baby3",
                                 baby4UserId:@"baby4",
