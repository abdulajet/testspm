...
typedef NS_ENUM(NSUInteger, ConversationTableCellMessageStatus) {
    ConversationTableCellMessageStatusNone,
    ConversationTableCellMessageStatusSeen,
    ConversationTableCellMessageStatusDelivered,
    ConversationTableCellMessageStatusDeleted
};
...
- (void)updateWithEvent:(NXMEvent *)event
          ...
          messageStatus:(ConversationTableCellMessageStatus)status;
@end
